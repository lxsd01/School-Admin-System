    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="ins/stud.php" class = "nav-link">My Students</a>
          </li>
          <li class="nav-item">
            <a href="ins/content.php" class = "nav-link">Learning Content</a>
          </li>
          <li class="nav-item">
            <a href="pages/annINS.php" class = "nav-link active">Announcements</a>
          </li>
